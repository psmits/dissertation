...
\begin{frame}
  ...
  \begin{quotation}
    ...
    \tiny{\attrib{Kitchell 1985 Paleobiology}}
  \end{quotation}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \tiny{\attrib{Grantham 1995 Ann. Rev. Ecol. Syst.}}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \tiny{\attrib{Liow et al. 2011 TREE}}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{alertblock}{Definition}
      ...
      \tiny{\attrib{Van Valen 1973 Evol. Theory}}
  \end{alertblock}
...
\begin{frame}
  ...
  \begin{block}{Probability of assignment}
    ...
    \]
    \tiny{\attrib{Simpson and Harnik 2009 Paleobiology}}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  % data source: PBDB, NOW, museums (FMNH, AMNH), published compliations
  %   h/t Alroy
\end{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        ...
        \tiny{\attrib{Sidor et al. 2013 PNAS}}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
