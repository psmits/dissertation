...
\begin{frame}
  ...
  \tiny{\attrib{Raup 1991 \textit{Extinction: Bad Genes or Bad Luck?}}}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \tiny{\attrib{Simpson 1944 \textit{Tempo and Mode}}}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{definition}
    \textbf{Adaptive zone:} The set of all interactions, biotic and abiotic, that a individual/taxon is adapted to or experiences.

    \textbf{Environment:} The set of all possible interactions, both biotic and abiotic.
  \end{definition}

  \tiny{\attrib{Simpson 1944 \textit{Tempo and Mode}, Simpson 1953 \textit{Major Features}}}

\end{frame}

\begin{frame}
  \frametitle{``Critical'' interactions}

  Traits and factors which govern the necessary set of interactors for a given adaptive zone.

  \begin{itemize}
    \item environmental preference
...
\begin{frame}
  ...
  \begin{block}{Concerns}
    Temporal and spatial variation in environments (\alert{selective pressure}).
  \end{block}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}
        ...
        \item provinciality and distinctiveness
      \end{itemize}
    \end{column}
  \end{columns}
...
% really need to explain this better
\begin{frame}
