...
\begin{frame}
  ...
  \begin{definition}
    ...
    Time is taxon duration or age. 

    Event is an occurrence of interest (extinction).
  \end{definition}
    ...
    \begin{column}{0.4\textwidth}
      \begin{itemize}
        ...
        \item time-independent traits
          \begin{itemize}
            \item prelim substrate following Foote 2006 \textit{Paleobio.}
            \item prelim habitat following Kiessling \textit{et al.} 2007 \textit{Paleo\(^3\)}
          \end{itemize}
