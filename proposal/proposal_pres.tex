...
\begin{frame}
  ...
  \begin{itemize}
    \item data: genus FAD--LAD
      \begin{itemize}
        \item Australiasia
        \item all taxa occurring in and ranging into/out of Permian
    ...
    \item climate: time-dep. covariate
      \begin{itemize}
        \item continuous or Heaviside step function
      \end{itemize}
    \item distributions of survival: \(\exp(\lambda)\), \(Weibull(\lambda, k)\), \textit{etc.}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item data: genus and species FAD--LAD
      \begin{itemize}
