...
% Sun Mar  2 20:55:01 2014
\begin{tiny}
\begin{longtable}{p{5cm} l l l l}
  \caption[Lithological assignments for Australian formations]{Australian formations included in the study of brachiopod survival and distribution (Section \ref{sec:brac}). Improvements are based on lithological descriptions from Geosciences Australia (\url{http://www.ga.gov.au/}).} \\ %\tabularnewline
%  \centering
