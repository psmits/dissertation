...
\begin{figure}[ht]
  ...
  \end{center}
  \caption{Biogeographic network summary statistics for mammalian communities in North America and Europe. The summary statistics are, clockwise from top right: average relative occupancy (avgcooc), biogeographic connectedness (bc), average relative number of endemics (end), code length (code).} 
  \label{fig:mam_tot}
\end{figure}
...
%  \end{center}
%  \caption{Survivorship curves of Australasian Permian brachiopod genera.}
