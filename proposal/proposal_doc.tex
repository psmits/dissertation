...
\begin{figure}[ht]
  ...
  \end{center}
  \caption[Biogeographic statistics for brachiopods]{Biogeographic network summary statistics for the East coast of Australia during the Permian.}
  \label{fig:brac_net}
\end{figure}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \end{subfigure}
  \end{center}
  \caption[Trait based brachiopod biogeographic summary statistics]{Traits}
  \label{fig:trait_net}
\end{figure}
