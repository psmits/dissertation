...
For example, species with larger geographic ranges tend to have lower extinction rates than species with smaller geographic ranges \citep{Jablonski1986,Harnik2013,Nurnberg2013a,Jablonski2003,Roy2009c}. All things being equal at the organism level, this pattern is expected given purely stochastic (i.e. biologically random) extinction \citep{Raup1991b}. The mechanisms that determine range size vary between clades, though, and remains a black box for most taxa \citep{Jablonski1987}. Without more information on taxa, it is therefore impossible to determine if differential extinction is caused by chance or as the product of selection. By modeling extinction via traits related to environmental preference, the relative importance of either of these two extremes can be elucidated.  % this paragraph needs to have more nuanced language re hierarchy 
