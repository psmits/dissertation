...
%\begin{frame}
%  \frametitle{Inference devices and statistical tests}
%
%  \begin{center}
%    \includegraphics[width = \textwidth,height = 0.8\textheight,keepaspectratio = true]{figure/mcelreath_tests}
%  \end{center}
%
%  \footnotesize{\attrib{McElreath 2015}}
%\end{frame}
%
%\begin{frame}
%  \frametitle{Building your own}
%
%  % why and how to develop models
%\end{frame}
