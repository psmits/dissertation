...
\section{Background extinction and expected differences in species survival}
...
\section{Interplay between extinction intensity and extinction selectivity}
...
\section{Mammal species pool functional composition}
...
%   45 minutes
% introduction
%   base this on the actual introduction from my dissertation
%   big ideas
%     macroevolution and macroecology
%     linked through traits
%     species fitness and selection
%   smaller parts of those big ideas
%     survival of the unspecialized
%     law of constant extinction
%     enrichment/depletion of ecotypes
%   how my studies fit?
%     survival models
%     species pool model
%   what are my overall goals?
%     demonstrate the interconnectedness of these two fields
% studies of survival
%   mammals
%   brachiopods
