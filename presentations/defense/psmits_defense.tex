  ...
  \begin{columns}
    ...
    \begin{column}{0.35\textwidth}
      \begin{itemize}
        ...
        \item \tiny{Jessica Escott, \alert{Ben Frable}, Brian Goodrich, Colin Kyle, \alert{Darcy Ross}, Elizabeth Sander, Laura Southcott, \alert{Julie Symaszek}, Brian Waligorski}
        \item \tiny{Jean Leahy}
      \end{itemize}
    \end{column}
