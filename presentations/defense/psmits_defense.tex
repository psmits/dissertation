...
\begin{frame}
  ...
  \footnotesize{\attrib{Simpson 2016 \em{bioRxiv}}}
\end{frame}
...
\begin{frame}
  ...
  \footnotesize{\attrib{Van Valen 1973 \em{Evol. Theory}}}
\end{frame}
...
\begin{frame}
  ...
  \footnotesize{\attrib{Simpson 1944 \em{Tempo and Mode in Evolution} p. 143}}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.55\textwidth}
      ...
      \end{quote}
      \footnotesize{\attrib{Mandelbrot}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \footnotesize{\attrib{Warton \textit{et al.} 2015 \em{Methods Ecol. Evol.}}}
\end{frame}

\begin{frame}
  \frametitle{Reading a probability}
  \begin{center}
    \includegraphics[width = \textwidth,height = 0.8\textheight,keepaspectratio = true]{figure/probability}
  \end{center}

  \footnotesize{\attrib{mathwithbaddrawings.com}}
...
\begin{frame}
  ...
  % picture showing these two groups like in my proposal
\end{frame}
...
\begin{frame}
  ...
  \footnotesize{\attrib{Smits 2015 \em{PNAS}}}
\end{frame}
...
\begin{frame}
  ...
  \footnotesize{\attrib{Wang 2003 \em{Paleobio.}}}
\end{frame}
